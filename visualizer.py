...
class Visualizer:
    ...
    def __init__(self, stream:Stream, vis_type:str=None, host:'Visualizer'=None,
            ...
            clear_after_end=False, clear_after_each=False, history_len=1, dim_history=True, opacity=None, window_width=None,#window_width  added fro cutting old values
        ...
        self._host_base.subscribe(stream, show=False, clear_after_end=clear_after_end, clear_after_each=clear_after_each,
            history_len=history_len, dim_history=dim_history, opacity=opacity, window_width=window_width ,#window_width  added fro cutting old values
